...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		this.prepareSidebarMenu = function()
		{
			...
			var reportes 		= this.addItem('Reportes', 			'/app/reportes', 		'linecons-doc');
			var transacciones 	= this.addItem('Transacciones', 	'/app/transacciones', 	'linecons-params');

				//Subitems of reportes
				reportes.addItem('Ventas', 			'-/ventas');
				reportes.addItem('Impuestos', 		'-/impuestos');
				reportes.addItem('Polizas', 		'-/polizas');
				reportes.addItem('Honorarios', 		'-/honorarios');
