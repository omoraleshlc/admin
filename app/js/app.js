...
app.config(function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, ASSETS){
	...
	$stateProvider.
		...
		state('app', {
			abstract: true,
			url: '/app',
			templateUrl: appHelper.templatePath('layout/app-body.html'),
		...
		state('app.dashboard', {
			url : '/dashboard',
			templateUrl: appHelper.templatePath('dashboard/index.php'),
			resolve: {
		...
		state('login', {
			url: '/login',
			templateUrl: appHelper.templatePath('login.html'),
		...
		state('login-light', {
			url: '/login-light',
			templateUrl: appHelper.templatePath('login-light.html'),
		...
		state('lockscreen', {
			url: '/lockscreen',
			templateUrl: appHelper.templatePath('lockscreen.html'),
