DXHotels.booking = function () {
    ...
    model.init = function () {
        ...
        var totalDays = totalDays(params.checkIn, params.checkOut);
        ...
        function totalDays(checkIn, checkOut) {
            ...
            while (checkIn <= checkOut) {
                days.push({ day: Globalize.format(checkIn, "dddd, MMMM dd, yyyy") });
        ...
        DXHotels.loadData({
            ...
            var address = value.Address,
                postelCode = value.Postal_Code,
                city = value.City,
                stateProvince = value.StateProvince,
                country = value.Country;
            model.fullAddress(DXHotels.getFullAddress(address, city, stateProvince, postelCode, country));
        });
