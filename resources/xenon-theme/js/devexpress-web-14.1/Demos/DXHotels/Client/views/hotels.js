DXHotels.hotels = function () {
    ...
    var getHotels = function (data) {
        ...
        for (var i = 0 ; i < data.length; i++) {
            ...
            var fullAddress = address + " " + city + ", " + (stateProvince ? stateProvince + ", " : "") + postalCode + ", " + country;
    ...
    model.goToHotel = function () {
        DXHotels.app.navigate({
            ...
            checkIn: Globalize.format(new Date(params.checkIn), "MM/dd/yyyy"),
            checkOut: Globalize.format(new Date(params.checkOut), "MM/dd/yyyy"),
